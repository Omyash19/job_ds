...
Here is the complete, final code for `app.py` including the UI design and the dummy data preview. 

To avoid the syntax error on your deployment, you can just click the **"Copy code"** button below and paste it to completely replace your current file.
